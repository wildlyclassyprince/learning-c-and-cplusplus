...
/* applying bit fields */
/* modified version of 'making_a_structure_flexible.c' */

struct  bit_field {int  cable: 1;
                   int  dish : 1;};
...
void  DataEnter(struct  survey *ptr)
{
  ...
  if ((is_yes[0] == 'Y') || (is_yes[0] == 'y'))
    ...
    printf("Your age:\n");
      scanf("%d", &ptr->age);
    printf("How many hours do you spend watching TV per week?\n");
