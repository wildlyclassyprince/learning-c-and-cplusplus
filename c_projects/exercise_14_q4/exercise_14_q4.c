...
This time, print out all arguments passed to the 'AddDouble()'
function. Does 'va_arg()' fetch each argument in the same order
(that is, from left to right) of the argument list passed to
'AddDouble()'?
Yes, 'va_arg()' reads from left to right.
*/

/* processsing variable arguments */
